...
#
files= c('per1clean.csv', 'per2clean.csv', 'per3clean.csv')
#
#pdf("peak gr.pdf")
#
shift <- 0
...
gfp_time_start <- 11700-1800 #gfp_peak_variance-900*1
mch_time_start <- 11700 #mch_peak_variance-900*5
...
p7 <- ggplot() +
  ...
  ggtitle(paste("Burden of GFP expression")) + ylim(0, 1) +
