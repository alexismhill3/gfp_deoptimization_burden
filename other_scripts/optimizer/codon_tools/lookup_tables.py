...
# T. Zhou, M. Weems, C. O. Wilke (2009). Translationally optimal codons associate with structurally sensitive sites in proteins. Mol. Biol. Evol. 26:1571–1580.    <- High-phi model
opt_codons_E_coli = {
    "A": ["GCT"],
    "R": ["CGT", "CGC"],
    "N": ["AAC"],
...
# Forward genetic code
# For each codon, provide the amino acid
