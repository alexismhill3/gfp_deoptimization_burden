...
cell_locations = {
    ...
    'C10': ['MCH75', 'R0.25', False],
    'D10': ['MCH75', 'R0.5', False],
    'E10': ['MCH75', 'R1', False],
    'F10': ['MCH75', 'R2', False],
    'G10': ['MCH75', 'R4', False],

    'B11': ['blank', 'blank', False],
    'C11': ['MCH90', 'R0.25', False],
    'D11': ['MCH90', 'R0.5', False],
    'E11': ['MCH90', 'R1', False],
    'F11': ['MCH90', 'R2', False],
    'G11': ['MCH90', 'R4', False],
